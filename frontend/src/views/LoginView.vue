...
<template>
  <div class="flex justify-center items-center h-screen bg-gray-950">
    <div class="relative">
      <div
        class="absolute inset-0.5 bg-gradient-to-tl from-purple-600 to-indigo-100 blur-md opacity-80"
      ></div>
      <div
        class="relative flex flex-col gap-4 items-center w-64 sm:w-96 p-4 rounded-xl bg-slate-900"
      >
        <span
